...
namespace PROGESO.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("cod_prod,descripcion")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("cod_prod,descripcion")] Producto producto)
        {
            if (id != producto.cod_prod)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProductoExists(producto.cod_prod))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Producto.Any(e => e.cod_prod == id);
        }
    }
}
